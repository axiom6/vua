            ...
            <template v-if="isSpecialField(field.name)">
              ...
              >
                ...
                <input type="checkbox" @change="toggleAllCheckboxes(field.name, $event)"
                  :checked="checkCheckboxesState(field.name)"></label>
              </th>
                ...
                <template v-if="isSpecialField(field.name)">
                  ...
                  >
                    <label><input type="checkbox"
                      ...
                      :checked="rowSelected(item, field.name)"></label>
                  </td>
        ...
        <template v-if="field.visible">
          <template v-if="isSpecialField(field.name)">
            <th v-if="extractName(field.name) === '__checkbox'"
              ...
              :class="['vuetable-th-checkbox-'+trackBy, field.titleClass]"
            >
              <label><input type="checkbox" @change="toggleAllCheckboxes(field.name, $event)"
                :checked="checkCheckboxesState(field.name)"></label>
            </th>
            <th v-if="extractName(field.name) === '__component'"
              :key="fieldIndex"
  ...
  methods: {
    ...
    getAppendParams (params) {
      for (let x in this.appendParams) {
        if( this.appendParams.hasOwnProperty(x) ) {
