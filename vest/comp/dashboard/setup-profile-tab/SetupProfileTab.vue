...
import VuesticWizard       from '../../../vesc/wizard/VuesticWizard.vue'
import VuesticSimpleSelect from '../../../vesc/simple-select/VuesticSimpleSelect.vue'

export default {
  name: 'setup-profile-tab',
  components:{ 'vuestic-wizard':VuesticWizard, 'vuestic-simple-select':VuesticSimpleSelect },
  props: {
    wizardType: {
      default: 'rich',
    },
